...
def handle_client(client_socket, client_address, admin_app):
    ...
    try:
        while True:
            ...
            if command == "authenticate" and len(args) == 2:
                ...
                if response == "Authentication successful":
                    # Update the client_sockets dictionary with the login name
                    admin_app.update_client_sockets(client_address, client_socket, login_name)
        ...
        # Remove the client socket from the dictionary when the client disconnects
        admin_app.remove_client_socket(client_address)
